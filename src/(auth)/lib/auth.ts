...
const key = new TextEncoder().encode("idujyyuehdkksuysuu2877Yunf")
...
export const VereficationEmail = async ({
    email,
    name,
    token,
    id,
...
export const generateRestePasswordToken = async (
    email: string,
    token: string,
) => {
    try {
...
export const ResetPassowrdEmail = async (
    secret: string,
    name: string,
    email: string,
) => {
