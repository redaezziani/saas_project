// lets make a new file called icons.tsx
...
export const EmployeeIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none">
            <path d="M13 7C13 9.20914 11.2091 11 9 11C6.79086 11 5 9.20914 5 7C5 4.79086 6.79086 3 9 3C11.2091 3 13 4.79086 13 7Z" stroke="currentColor" fill='#ffff' stroke-width="1.5" />
            <path d="M15 11C17.2091 11 19 9.20914 19 7C19 4.79086 17.2091 3 15 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill='#ffff' stroke-linejoin="round" />
            <path d="M11 14H7C4.23858 14 2 16.2386 2 19C2 20.1046 2.89543 21 4 21H14C15.1046 21 16 20.1046 16 19C16 16.2386 13.7614 14 11 14Z" fill='#ffff' stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
            <path d="M17 14C19.7614 14 22 16.2386 22 19C22 20.1046 21.1046 21 20 21H18.5" stroke="currentColor" stroke-width="1.5" fill='#ffff' stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    );
}
...
export const FilterIcon = () => {
    return (
        <svg
            className='  text-slate-400/95 fill-slate-400/65'
            color='currentColor'
...
export const OptionsIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="none">
            <path d="M4 5H5.04362C6.96246 5 7.92187 5 8.67328 5.49548C9.42469 5.99095 9.80263 6.8728 10.5585 8.63648L13.4415 15.3635C14.1974 17.1272 14.5753 18.009 15.3267 18.5045C16.0781 19 17.0375 19 18.9564 19H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
            <path d="M14 5H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
        </svg>
    );
}
