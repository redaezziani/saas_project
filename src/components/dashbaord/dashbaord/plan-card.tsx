...
const PlanCard = () => {
    ...
    const handelCheckout = async (priceId: string) => {
        ...
        const data: { status: string; session?: { id: string } } = await result.json();
    ...
    return (
        ...
        <Drawer
            open={isPlanActive===false?true:false}
        >
            <DrawerTrigger></DrawerTrigger>
            <DrawerContent
                className="  min-h-64 focus:outline-none focus-within:outline-none focus:border-none"
            >
                <div className="w-full p-4  flex flex-col gap-3 justify-center items-center h-full">
                    <div className="w-full max-w-4xl flex flex-col gap-2 justify-start items-start">
                        <h1
                        ...
                        >
                            You are currently on a free plan. Upgrade your plan to unlock more features.
                        </p>
                        <hr
                            className="w-full border border-slate-400/35 mt-4 border-dashed"
                        />

                        <div className="grid lg:grid-cols-2 px-8 gap-10 text-zinc-800 mt-10">
                            <div className=" hidden md:flex flex-col items-center bg-slate-100 p-8 rounded-lg border border-slate-400/35 max-w-sm">
                                <div>
                            ...
                            <div
                                className="flex flex-col items-center bg-gradient-to-br from-blue-100 via-orange-100 to-purple-100 p-8 rounded-lg border border-slate-400/35 relative  border-orange-200 max-w-sm">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex justify-center mt-8">
                                        <Button
                                            onClick={() => handelCheckout('price_1PP6cEHDE7eZdLsNHjFyNpj2')}
