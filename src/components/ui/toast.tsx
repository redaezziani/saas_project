...
>(({ className, variant, ...props }, ref) => {
    const variantIcons = {
        success: (
            <div className="border-primary-500/55 before:border-primary-500/30 relative flex size-8 items-center justify-center rounded-full border before:absolute before:size-12 before:rounded-full before:border">
                <svg
