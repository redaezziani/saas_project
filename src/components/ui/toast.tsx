...
>(({
  ...
  const variantIcons = {
    ...
    error: (
      <div className="size-8 border-red-500/55 border rounded-full flex justify-center items-center relative before:size-12 before:border before:border-red-500/30 before:rounded-full before:absolute">
      <svg
    ...
    default: (
      <div className="size-8 border-slate-500/55 border rounded-full flex justify-center items-center relative before:size-12 before:border before:border-slate-500/30 before:rounded-full before:absolute">
      <svg
